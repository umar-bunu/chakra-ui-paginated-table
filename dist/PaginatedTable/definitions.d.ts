...
import { ButtonProps, FlexProps, TableBodyProps, TableContainerProps, TableHeadProps, TableProps, TableRowProps } from "@chakra-ui/react";
export interface TAmazingCol<TRecord> {
    title: React.ReactNode;
    dataIndex?: keyof TRecord | undefined;
    key: string | number;
    render?: (value: NonNullable<this["dataIndex"]>, record: TRecord, index?: number) => React.ReactNode;
...
export interface PaginatedTableProps {
    ...
    columns: TAmazingCol<InferArrayElementType<PaginatedTableProps["dataSource"]>>[];
...
type IRecordProps<TWhichProp, TRecord = Record<string, any>> = (record: TRecord, recordIndex: number) => TWhichProp;
export {};
